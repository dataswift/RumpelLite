...
{
    [self hnk_setImageFromURL:url placeholder:nil headers:nil success:nil failure:nil update:nil];
}

- (void)hnk_setImageFromURL:(NSURL*)url placeholder:(UIImage *)placeholder
{
    [self hnk_setImageFromURL:url placeholder:placeholder headers:nil success:nil failure:nil update:nil];
}
