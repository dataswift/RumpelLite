...
internal var deviceLanguage = ""
internal var locale = ""

@available(*, deprecated, message: "use setupSnapshot: instead")
internal func setLanguage(_ app: XCUIApplication) {
    setupSnapshot(app)
}

internal func setupSnapshot(_ app: XCUIApplication) {
    Snapshot.setupSnapshot(app)
}

internal func snapshot(_ name: String, waitForLoadingIndicator: Bool = true) {
