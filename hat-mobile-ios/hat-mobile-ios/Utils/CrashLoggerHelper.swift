...
internal struct CrashLoggerHelper {
    ...
    static func authenticationErrorLog(error: AuthenicationError) -> UIAlertController {
        ...
        case .cannotSplitToken(let description):
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["Cannot split token. Error: ": "\(description)"])
            
            // no token in url callback redirect
            return UIAlertController.createOKAlert(
                alertMessage: "Token error!",
                alertTitle: "Cannot split token",
                okTitle: "OK",
                proceedCompletion: {})
        case .cannotDecodeToken(let description):
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["Cannot decode token. Error: ": "\(description)"])
            
            // no token in url callback redirect
            return UIAlertController.createOKAlert(
                alertMessage: "Token error!",
                alertTitle: "Cannot decode token",
                okTitle: "OK",
                proceedCompletion: {})
        ...
        case .noIssuerDetectedError(let description):
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["No issuer detected in the token. Error: ": "\(description)"])
            
            // no token in url callback redirect
            return UIAlertController.createOKAlert(
                alertMessage: "Token error!",
                alertTitle: "Cannot detect issuer",
                okTitle: "OK",
                proceedCompletion: {})
        case .noTokenDetectedError:
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["No token detected": ""])
            
            // no token in url callback redirect
            return UIAlertController.createOKAlert(
                alertMessage: NSLocalizedString("auth_error_no_token_in_callback", comment: "auth"),
                alertTitle: NSLocalizedString("error_label", comment: "error"),
                okTitle: "OK",
                proceedCompletion: {})
        case .tokenValidationFailed(let description):
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["Token validation failed. Error: ": "\(description)"])
            
            return UIAlertController.createOKAlert(
                alertMessage: NSLocalizedString("auth_error_invalid_token", comment: "auth"),
                alertTitle: NSLocalizedString("error_label", comment: "error"),
                okTitle: "OK",
                proceedCompletion: {})
        }
    ...
    static func dataPlugErrorLog(error: DataPlugError) -> UIAlertController? {
        ...
        case .noValueFound:
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["No value found in the response": ""])
            
            // no token in url callback redirect
            return UIAlertController.createOKAlert(
                alertMessage: "Response error!",
                alertTitle: "No value found in the response",
                okTitle: "OK",
                proceedCompletion: {})
        case .generalError(let description, let statusCode, let errorReturned):
            ...
            if statusCode != nil && errorReturned != nil {
                ...
                Crashlytics.sharedInstance().recordError(
                    errorReturned!,
                    withAdditionalUserInfo: ["General error. Error: ": "\(errorReturned!)",
                        "status code: ": "\(statusCode!)",
                        "description: ": "\(description)"]
                )
            } else if statusCode != nil {
            ...
            // no token in url callback redirect
            let msg: String = NetworkHelper.exceptionFriendlyMessage(
                statusCode,
    ...
    static func hatTableErrorLog(error: HATTableError) -> UIAlertController {
        ...
        case .noTableIDFound:
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["No table ID found ": ""])
            
            // no token in url callback redirect
            return UIAlertController.createOKAlert(
                alertMessage: "No table ID found!",
                alertTitle: "Table ID not found in the server",
                okTitle: "OK",
                proceedCompletion: {})
        case .noValuesFound:
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["No value found ": ""])
            
            // no token in url callback redirect
            return UIAlertController.createOKAlert(
                alertMessage: "No value found!",
                alertTitle: "Value not found in the server",
                okTitle: "OK",
                proceedCompletion: {})
        case .tableDoesNotExist:
            ...
            Crashlytics.sharedInstance().recordError(
                error,
                withAdditionalUserInfo: ["Table does not exist ": ""])
            
            // no token in url callback redirect
            return UIAlertController.createOKAlert(
                alertMessage: "Requested table does not exist!",
                alertTitle: "Requested table does not exist in the server",
                okTitle: "OK",
                proceedCompletion: {})
        case .generalError(let description, let statusCode, let errorReturned):
