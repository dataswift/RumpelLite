        ...
        DispatchQueue.main.async { [weak self] in
            ...
            for index in weakSelf.sections.indices {
                ...
                if cell == nil {
                    ...
                    cell = weakSelf.tableView.dequeueReusableCell(withIdentifier: Constants.CellReuseIDs.dietaryHabitsCell, for: indexPath) as? SurveyTableViewCell
                ...
                guard let answer = cell?.getSelectedAnswer(), weakSelf.surveyObjects.count > index  else {
                    
                    break
                }
                
                weakSelf.surveyObjects[index].answer = answer
            }
