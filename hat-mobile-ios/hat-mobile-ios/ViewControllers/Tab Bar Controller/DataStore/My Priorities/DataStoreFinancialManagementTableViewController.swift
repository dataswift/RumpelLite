...
internal class DataStoreFinancialManagementTableViewController: UITableViewController, UserCredentialsProtocol {
    
    // MARK: - Variables
    
    /// The sections of the table view
    private let sections: [[String]] = [["Buying from Ethical companies"], ["Controlling my spending"], ["Budgeting wisely"]]
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            for index in weakSelf.sections.indices {
                ...
                if cell == nil {
                    ...
                    cell = weakSelf.tableView.dequeueReusableCell(withIdentifier: Constants.CellReuseIDs.financialManagementCell, for: indexPath) as? SurveyTableViewCell
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: Constants.CellReuseIDs.financialManagementCell, for: indexPath) as? SurveyTableViewCell
