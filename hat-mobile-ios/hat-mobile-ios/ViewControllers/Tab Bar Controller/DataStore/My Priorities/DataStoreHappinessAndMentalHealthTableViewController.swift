...
internal class DataStoreHappinessAndMentalHealthTableViewController: UITableViewController, UserCredentialsProtocol {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            for index in weakSelf.sections.indices {
                ...
                if cell == nil {
                    ...
                    cell = weakSelf.tableView.dequeueReusableCell(withIdentifier: Constants.CellReuseIDs.happinesAndMentalHealthCell, for: indexPath) as? SurveyTableViewCell
            ...
            HappinessAndMentalCachingWrapperHelper.postSurveyObject(
    ...
    private func getSurveyQuestionsAndAnswers() {
        ...
        HappinessAndMentalCachingWrapperHelper.getSurveyObject(
            userToken: userToken,
            userDomain: userDomain,
            cacheTypeID: "happinessAndMentalHealth",
